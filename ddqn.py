...
class DQN():
  ...
  def create_Q_network(self):
    ...
    e_params = tf.compat.v1.get_collection(tf.compat.v1.GraphKeys.GLOBAL_VARIABLES, scope='current_net')
  ...
  def create_training_method(self):
    ...
    self.cost = tf.compat.v1.reduce_mean(tf.square(self.y_input - Q_action))
